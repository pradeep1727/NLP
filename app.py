...
def analyse():
    if request.method == 'POST':
        ...
        row_contents1 = [rawtext,tag]
        append_list_as_row('test.csv', row_contents1)

    return render_template('result.html',received_text = rawtext,summary=summary,tag=tag, polarity= blob_polarity, subjectivity = blob_subjectivity)
...
#def data1():
 ...
 #   return render_template('data1.html', data1=df2.to_html())
